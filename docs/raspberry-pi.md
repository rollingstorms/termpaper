...
The first frame after display initialization performs one startup white clear.
This is intentional; it helps remove stale color-plane state before drawing
